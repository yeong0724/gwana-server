...
--
-- Host: localhost    Database: social-login
-- ------------------------------------------------------
...
--
-- Current Database: `social-login`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `social-login` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
INSERT INTO `social_account` VALUES ('0P927VJ0N78QX','0P927VHWN78QN','kakao',3754082803,'2026-01-24 19:21:58',NULL,'2026-01-24 19:21:58',NULL),('0P94CQNBRC4SN','0P94CQNA4C4SP','kakao',4465641748,'2026-01-25 00:22:54',NULL,'2026-01-25 00:22:54',NULL);
...
CREATE TABLE `token` (
  ...
  `ACCESS_TOKEN_EXPIRES_AT` datetime NOT NULL COMMENT 'Access Token 만료시간',
  `REFRESH_TOKEN_EXPIRES_AT` datetime NOT NULL COMMENT 'Refresh Token 만료시간',
  `created_at` datetime DEFAULT NULL,
  `created_by` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `modified_at` datetime DEFAULT NULL,
  `modified_by` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`TOKEN_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='사용자 토큰 관리 테이블';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `token` VALUES ('0QBHFFDNG8CX3','0P927VHWN78QN','eyJhbGciOiJIUzUxMiJ9.eyJ1c2VySWQiOiIwUDkyN1ZIV043OFFOIiwiaWF0IjoxNzc4NTA0NzUwLCJleHAiOjE3Nzg1MDY1NTB9.n9IC91U8Sh9nnbxmPtRamu_0dW-a4zFqEJ3P2lVjhTaT9zpU0EZdyPpGPXYbd9sWIEyBVI4IHn6DC5wBFHiBXQ','eyJhbGciOiJIUzUxMiJ9.eyJ1c2VySWQiOiIwUDkyN1ZIV043OFFOIiwiaWF0IjoxNzc4NTA0NzUwLCJleHAiOjE3Nzg1OTExNTB9.vBX9ynbvijtMlgIDt6dVGn0aQKpmjNI0L3TXYQWpxfV4vXCtno0TIx4LBbdpx2E9ueBHVsLxBerh-g1Uvizbyg','4falDXqyKUvKwzZOovxh47eNTBOL3S4_AAAAAQoNIJsAAAGeFWB2XiJyl_dg0lnq','2026-05-11 22:35:51','2026-05-12 22:05:51','2026-05-11 22:05:51',NULL,NULL,NULL),('0QBVXVPF4TCZH','0P94CQNA4C4SP','eyJhbGciOiJIUzUxMiJ9.eyJ1c2VySWQiOiIwUDk0Q1FOQTRDNFNQIiwiaWF0IjoxNzc4NTkyNDA3LCJleHAiOjE3Nzg1OTQyMDd9.C2iArogo1VCDGybF5_JtiOht07mr8IJtgNoarC86fOijF-hhjAJoFhMKi8P1yu3qgW9MQ3KdaQNVMQhDCM6V0g','eyJhbGciOiJIUzUxMiJ9.eyJ1c2VySWQiOiIwUDk0Q1FOQTRDNFNQIiwiaWF0IjoxNzc4NTkyNDA3LCJleHAiOjE3Nzg2Nzg4MDd9.eMlWnJi7Gt0xyVMi3Vpjlme-hhEAgXjUFws4IScVYLkmHqriDSwnQ3oVrw57nOpDiDRLtxg_QscPkuEEWhl4gw','PTE77cs15F2mQT-yKcl5_5_6Tt7ScgPEAAAAAQoNCB4AAAGeHA5-663XznpenZPe','2026-05-12 22:56:47','2026-05-13 22:26:47','2026-05-12 22:26:47',NULL,NULL,NULL);
...
-- Dump completed on 2026-07-24 17:49:49
